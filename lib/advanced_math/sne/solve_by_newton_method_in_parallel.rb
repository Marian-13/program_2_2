module AdvancedMath
  class SNE
    class SolveByNewtonMethodInParallel
      attr_reader :vector_function, :matrix_function, :initial_vector, :epsilon, :processors

      def initialize(vector_function:, matrix_function:, initial_vector:, epsilon:, processors:)
      ...
      def call
        ...
        loop do
          ...
          sle.matrix = generate_matrix_by_matrix_function_in_parallel(
            matrix_function,
            current_vector_x,
            processors
          )
          sle.vector = -generate_vector_by_vector_function_in_parallel(
            vector_function,
            current_vector_x,
            processors
          )
          ...
          next_vector_delta_x =
            sle.solve_by_lu_decomposition_in_parallel(processors: processors)
      ...
      private
        ...
        def generate_matrix_by_matrix_function_in_parallel(matrix_function, vector, processors)
          GenerateMatrixByMatrixFunctionInParallel.new(
            matrix_function: matrix_function,
            vector: vector,
            processors: processors
          ).call
        ...
        def generate_vector_by_vector_function_in_parallel(vector_function, vector, processors)
          GenerateVectorByVectorFunctionInParallel.new(
            vector_function: vector_function,
            vector: vector,
            processors: processors
          ).call
